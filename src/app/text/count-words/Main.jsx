                ...
                <div className="w-full h-full px-2 flex flex-col items-center justify-center">
                    ...
                    <div className=" h-full w-full grid grid-cols-2 place-items-center">
                        <div className="p-2 flex flex-col items-center justify-center">
                            ...
                            <div className="text-xs tracking-[1px] leading-[1.4]"><b>Words</b></div>
                        </div>
                        <div className="p-2 flex flex-col items-center justify-center">
                            <div className="text-2xl lg:text-4xl font-bold mb-2">
                                {letters}
                            </div>
                            <div className="text-xs tracking-[1px] leading-[1.4]">Characters</div>
                        </div>
                        <div className="p-2 flex flex-col items-center justify-center">
                            <div className="text-2xl lg:text-4xl font-bold mb-2">
                                {charactersWithoutSpace}
                            </div>
                            <div className="text-xs tracking-[1px] leading-[1.4]">Characters (no space)</div>
                        </div>
                        <div className="p-2 flex flex-col items-center justify-center">
                            <div className="text-2xl lg:text-4xl font-bold mb-2">
                                {sentences}
